...
4. GPT-5.6-Sol, 추론 수준 Low 이상을 사용합니다.
5. 수정 후 자동 테스트와 화면 검사를 모두 진행합니다.
6. 담당자 승인 전에는 운영에 배포하지 않습니다.

잘 모르겠거나 판단하기 어려운 부분은 부담 갖지 말고 언제든 위 이메일로 문의해 주세요. 작은 질문이라도 괜찮습니다. 문제가 커진 뒤 복구하는 것보다, 변경 전에 한 번 더 확인하는 것이 훨씬 안전합니다.

---

## 마지막으로

AI는 코드를 빠르게 찾고 수정할 수 있지만, 운영 데이터와 배포 결과까지 항상 올바르게 판단해 주는 것은 아닙니다.
